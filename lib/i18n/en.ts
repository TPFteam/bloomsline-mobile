export default {
  ...
  practitioner: {
    ...
    noResourcesSubtitle: 'Your practitioner will share worksheets and exercises here.',
    viewAll: 'View all',
    viewLess: 'View less',
    upcomingSessions: 'Upcoming Sessions',
    noUpcoming: 'No upcoming sessions',
    noUpcomingSubtitle: 'Your practitioner will schedule sessions with you.',
    sessionHistory: 'Session History',
    noHistory: 'No session history',
    noHistorySubtitle: 'Completed sessions will appear here.',
