export default {
  ...
  practitioner: {
    ...
    noResources: 'Vos exercices apparaîtront ici',
    noResourcesSubtitle: 'Quand votre praticien partage des fiches, exercices ou lectures, vous les trouverez ici. Complétez-les à votre rythme.',
    viewAll: 'Voir tout',
    viewLess: 'Voir moins',
    upcomingSessions: 'Séances à venir',
    noUpcoming: 'Aucune séance prévue pour le moment',
    noUpcomingSubtitle: 'Quand votre praticien planifie une séance, elle apparaîtra ici avec tous les détails.',
    sessionHistory: 'Historique des séances',
    noHistory: 'Pas encore de séances passées',
    noHistorySubtitle: 'Après vos séances, elles apparaîtront ici pour que vous puissiez revoir votre parcours.',
    ...
    submit: 'Soumettre',
    confirmSubmitTitle: 'Soumettre votre réponse ?',
    confirmSubmitMessage: 'Vous ne pourrez plus modifier après soumission.',
