...
const MOMENTS_HOW: QuizSlide[] = [
  ...
  { bg: '#F97316', en: { question: 'When’s the right time to capture?', optionA: 'Only when something big happens', optionB: 'Whenever you feel like it', correct: 'b', feedback: "No schedule, no quota. The best time is whenever a feeling shows up.", wrongFeedback: "Even tiny moments count. Capture whenever something stands out — big or small." }, fr: { question: 'C\'est quand, le bon moment ?', optionA: 'Quand il se passe quelque chose d\'important', optionB: 'Dès que vous en avez envie', correct: 'b', feedback: "Pas de planning, pas de quota. Le bon moment, c\'est dès qu\'un ressenti apparaît.", wrongFeedback: "Les petits moments comptent aussi. Capturez dès que quelque chose vous touche." } },
