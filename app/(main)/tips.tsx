...
const MOMENTS_HOW: QuizSlide[] = [
  ...
  { bg: '#F97316', en: { question: 'When’s the right time to capture?', optionA: 'Only when something big happens', optionB: 'Whenever you need it, whenever you want it', correct: 'b', feedback: "No schedule, no quota. Whenever something moves you, that's the right moment.", wrongFeedback: "Even tiny moments count. Capture whenever something stands out — big or small." }, fr: { question: 'C\'est quand, le bon moment ?', optionA: 'Quand il se passe quelque chose d\'important', optionB: 'Quand vous en avez besoin, quand vous en avez envie', correct: 'b', feedback: "Pas de planning, pas de quota. Dès que quelque chose vous touche, c\'est le bon moment.", wrongFeedback: "Les petits moments comptent aussi. Capturez dès que quelque chose vous touche." } },
